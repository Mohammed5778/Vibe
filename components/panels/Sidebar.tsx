    ...
    <div className="glass-pane rounded-xl h-full flex flex-col p-3">
      ...
      <div className="flex flex-col gap-2 mb-4">
        ...
        <div className="flex gap-2">
            ...
            <button onClick={actions.importFromDevice} className="w-full flex items-center justify-center gap-2 bg-dark-pane hover:bg-dark-border border border-dark-border rounded-md px-3 py-2 text-sm font-semibold transition-colors">
